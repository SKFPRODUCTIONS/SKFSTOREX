...
const defaultGames = [
    // Games
    {
        ...
        icon: 'https://i.ibb.co/VvBbHKP/spiderman.jpg',
    ...
    },
    {
        ...
        icon: 'https://i.ibb.co/VvBbHKP/gta6.jpg',
    ...
    },
    {
        ...
        icon: 'https://i.ibb.co/VvBbHKP/cod.jpg',
    ...
    // Apps
    {
        ...
        icon: 'https://i.ibb.co/VvBbHKP/photoshop.jpg',
    ...
    },
    {
        ...
        icon: 'https://i.ibb.co/VvBbHKP/vscode.jpg',
    ...
    },
    {
        ...
        icon: 'https://i.ibb.co/VvBbHKP/obs.jpg',
    ...
    },
    {
        ...
        icon: 'https://i.ibb.co/VvBbHKP/spotify.jpg',
...
// Load games from storage with error handling
const loadGames = () => {
    try {
        console.log('Loading games and apps...');
        const storedGames = localStorage.getItem(STORAGE_KEY);
        
        // Always start with default games to ensure we have the latest structure
        games = [...defaultGames];
        ...
        if (storedGames) {
            ...
            // Validate each item and merge with defaults
            if (Array.isArray(parsedGames)) {
                // Filter out any invalid items and merge with defaults
                const validGames = parsedGames.filter(item =>
                    item &&
                    item.id &&
                    item.name &&
                    item.description &&
                ...
                games = [
                    ...defaultGames,
                    ...validGames.filter(item =>
                        !defaultGames.some(defaultItem => defaultItem.id === item.id)
                    )
                ];
            }
        }
        ...
        console.log('Games and apps loaded successfully:', games);
            ...
            gameGrid.innerHTML = paginatedGames.map(game => {
                ...
                return `
                    <div class="game-card">
                        ...
                        <h2>${sanitizeHTML(game.name)}</h2>
                        <p>${sanitizeHTML(game.description)}</p>
                        <a href="${sanitizeHTML(game.downloadLink)}" class="download-btn" target="_blank" rel="noopener noreferrer">
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        // Load initial games and apps
        loadGames();
        console.log('Games and apps loaded:', games);
